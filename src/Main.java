...
public class Main {
    public static void main(String[] args) {
        ...
        harry.addGrade(78); harry.addGrade(89); harry.addGrade(99); harry.addGrade(51);

        Student ron = new Student("Ron", "Weasley", 20, true);
        ron.addGrade(78); ron.addGrade(89); ron.addGrade(75); ron.addGrade(63); ron.addGrade(82);

        Student hermione = new Student("Hermione", "Granger", 19, false);
        hermione.addGrade(100); hermione.addGrade(99); hermione.addGrade(95);
        hermione.addGrade(98); hermione.addGrade(100); hermione.addGrade(96); hermione.addGrade(97);
